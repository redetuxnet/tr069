exports.get = async function getMac(mac) {
    ...
    LEFT JOIN produto_item ON produto_item.id_produto = produto_usuario.id_produto
    LEFT JOIN ordem_servico_reserva ON produto_usuario.id_usuario = ordem_servico_reserva.id_usuario
